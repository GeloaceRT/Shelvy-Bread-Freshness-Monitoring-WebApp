    ...
    <div className="dashboard-container">
      ...
      <div className="sidebar">
        ...
        <div className="welcome-section">
          ...
          <p className="dashboard-subtitle">{user ? user.name : 'Baker Dashboard'}</p>
        </div>
        ...
        <nav className="navigation">
          ...
          <div className={`nav-item ${activePage === "home" ? "active" : ""}`} onClick={() => setActivePage("home")}>
            <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M12.5 18.2998V11.6331C12.5 11.4121 12.4122 11.2002 12.2559 11.0439C12.0996 10.8876 11.8877 10.7998 11.6667 10.7998H8.33333C8.11232 10.7998 7.90036 10.8876 7.74408 11.0439C7.5878 11.2002 7.5 11.4121 7.5 11.6331V18.2998" stroke="#3D2914" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M2.5 9.13289C2.49994 8.89044 2.55278 8.65091 2.65482 8.43098C2.75687 8.21106 2.90566 8.01605 3.09083 7.85955L8.92417 2.85955C9.22499 2.60531 9.60613 2.46582 10 2.46582C10.3939 2.46582 10.775 2.60531 11.0758 2.85955L16.9092 7.85955C17.0943 8.01605 17.2431 8.21106 17.3452 8.43098C17.4472 8.65091 17.5001 8.89044 17.5 9.13289V16.6329C17.5 17.0749 17.3244 17.4988 17.0118 17.8114C16.6993 18.124 16.2754 18.2996 15.8333 18.2996H4.16667C3.72464 18.2996 3.30072 18.124 2.98816 17.8114C2.67559 17.4988 2.5 17.0749 2.5 16.6329V9.13289Z" stroke="#3D2914" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
            <span>Home</span>
          </div>

          {/* Devices */}
          <div className={`nav-item ${activePage === "devices" ? "active" : ""}`} onClick={() => setActivePage("devices")}>
            <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M17.5 7.46606C17.4997 7.17379 17.4225 6.88674 17.2763 6.6337C17.13 6.38066 16.9198 6.17053 16.6667 6.0244L10.8333 2.69106C10.58 2.54478 10.2926 2.46777 10 2.46777C9.70744 2.46777 9.42003 2.54478 9.16667 2.69106L3.33333 6.0244C3.08022 6.17053 2.86998 6.38066 2.72372 6.6337C2.57745 6.88674 2.5003 7.17379 2.5 7.46606V14.1327C2.5003 14.425 2.57745 14.7121 2.72372 14.9651C2.86998 15.2181 3.08022 15.4283 3.33333 15.5744L9.16667 18.9077C9.42003 19.054 9.70744 19.131 10 19.131C10.2926 19.131 10.58 19.054 10.8333 18.9077L16.6667 15.5744C16.9198 15.4283 17.13 15.2181 17.2763 14.9651C17.4225 14.7121 17.4997 14.425 17.5 14.1327V7.46606Z" stroke="#3D2914" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M2.75 6.63281L10 10.7995L17.25 6.63281" stroke="#3D2914" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M10 19.1331V10.7998" stroke="#3D2914" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
            <span>Devices</span>
          </div>

          {/* Monitoring */}
          <div className={`nav-item ${activePage === "monitoring" ? "active" : ""}`} onClick={() => setActivePage("monitoring")}>
            <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M18.3334 10.8001H16.2667C15.9026 10.7994 15.5481 10.9179 15.2577 11.1376C14.9672 11.3573 14.7567 11.6661 14.6584 12.0168L12.7001 18.9835C12.6875 19.0267 12.6611 19.0648 12.6251 19.0918C12.589 19.1188 12.5452 19.1335 12.5001 19.1335C12.455 19.1335 12.4111 19.1188 12.3751 19.0918C12.339 19.0648 12.3127 19.0267 12.3001 18.9835L7.70008 2.6168C7.68746 2.57352 7.66114 2.53551 7.62508 2.50846C7.58902 2.48142 7.54516 2.4668 7.50008 2.4668C7.455 2.4668 7.41114 2.48142 7.37508 2.50846C7.33902 2.53551 7.3127 2.57352 7.30008 2.6168L5.34175 9.58346C5.2438 9.93276 5.03457 10.2406 4.7458 10.4601C4.45704 10.6797 4.10451 10.7991 3.74175 10.8001H1.66675" stroke="#3D2914" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          ...
          <div className={`nav-item ${activePage === "logs" ? "active" : ""}`} onClick={() => setActivePage("logs")}>
            <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M12.4999 2.4668H4.99992C4.55789 2.4668 4.13397 2.64239 3.82141 2.95495C3.50885 3.26751 3.33325 3.69144 3.33325 4.13346V17.4668C3.33325 17.9088 3.50885 18.3327 3.82141 18.6453C4.13397 18.9579 4.55789 19.1335 4.99992 19.1335H14.9999C15.4419 19.1335 15.8659 18.9579 16.1784 18.6453C16.491 18.3327 16.6666 17.9088 16.6666 17.4668V6.63346L12.4999 2.4668Z" stroke="#3D2914" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M11.6667 2.4668V5.80013C11.6667 6.24216 11.8423 6.66608 12.1549 6.97864C12.4675 7.2912 12.8914 7.4668 13.3334 7.4668H16.6667" stroke="#3D2914" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round"/>
